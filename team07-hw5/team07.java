...
public class team07 {
    ...
    private static void insertForest(Connection conn) throws SQLException {
        ...
        try {
            ...
            String query3 = "SELECT abbreviation FROM STATE";
            ...
            while (res2.next()) {
                confirmNum = res2.getInt("forest_no");
                System.out.println("");
    ...
    private static void insertSensor(Connection conn) throws SQLException {
        ...
        try {
            ...
            conn.setAutoCommit(false);
            PreparedStatement insertSensor = conn.prepareStatement("INSERT INTO SENSOR (x, y, last_charged, maintainer, last_read, energy) VALUES (?, ?, TO_TIMESTAMP(?, 'mm/dd/yyyy hh24:mi'), ?, TO_TIMESTAMP(?, 'mm/dd/yyyy hh24:mi'), ?)");
            insertSensor.setDouble(1, x);
            insertSensor.setDouble(2, y);
            insertSensor.setString(3, last_charged);
            insertSensor.setString(4, maintainer);
            insertSensor.setString(5, last_read);
            insertSensor.setInt(6, energy_level);
    ...
    private static void updateSensorStatus(Connection conn) throws SQLException {
        ...
        try {
            ...
            upDateSensor.setInt(1, energy_level);
    ...
    private static void findTopK(Connection conn) throws SQLException {
        ...
        if(!res1.next())
            System.out.println("There is no busy workers now.");
        else {
            do {
